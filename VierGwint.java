...
public class VierGwint extends AUf1.Spiel implements AUf1.Protokolierbar {
    private AUf1.Spieler cuSpieler;
    private AUf1.Spieler spieler1;
    private Spieler spieler2;
    private Scanner uInput = new Scanner(System.in);


    @Override          //Eingabe im Feld hinfuegen
    public boolean hinfugen(AUf1.Spielfeld spielfeld, int x, int y, AUf1.Spieler cuSpieler) {
    ...
    public void entfernen(AUf1.Spielfeld spielfeld, int x, int y, AUf1.Spieler cuSpieler) {
        for(int row1 = spielfeld.getX() - 1; row1 >= 0; row1 --) {
    ...
    public boolean spielzuge(AUf1.Spielfeld spielfeld, int x, int y, AUf1.Spieler cuSpieler) {
...
// Spielfeldkoordinaten
            ...
            x = uInput.nextInt();
            y = uInput.nextInt();
            AUf1.Spielfeld feld = new AUf1.Spielfeld(x,y);
...
//Spiel verlauf
    ...
    private  boolean checkGewinner(AUf1.Spielfeld spielfeld) {
    ...
    private void checkObUnentschieden(AUf1.Spielfeld board) {
